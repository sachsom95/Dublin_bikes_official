...
def connectMysql(station_list,now):
    ...
    for i in station_list:
        ...
        structure_time, station_number, station_name, address, position_lat, position_lng, banking, bonus, bike_stands,available_stands, available_bikes, status, last_update,weather['temp'],weather['feels_like'], weather['temp_min'], weather['temp_max'], weather['wind_speed'], weather['icon'],weather['description'])
        ...
        available_stands, available_bikes, status,last_update, weather['temp'],weather['feels_like'], weather['temp_min'],
