...
query = "UPDATE bikes.weather SET date = '{}',time='{}', temp = {}, feels_like = {} ,temp_min = {}, temp_max = {}, wind_speed = {},icon = '{}', lat = {}, lon = {}, description = '{}' WHERE lat = {}".format(weather['date'],weather['time'],weather['temp'],weather['feels_like'],weather['temp_min'],weather['temp_max'],weather['wind_speed'],weather['icon'],latitude,longtitude,weather['description'],latitude)
print(query)
